...
// };
        ...
        u_int32_t timestampValue = (__u32)(current_time*10);
#ifdef DEBUG
        ...
        switch(nmap_result) {
            case TCP_NMAP_ECN: {
                ...
                */
                ...
                else
                {
                    ...
                    (*(u_int32_t *)(cursor +  4)) = bpf_htonl(0x01030306);
                    (*(u_int32_t *)(cursor +  8)) = bpf_htonl(0x04020000);
                }
            ...
            case TCP_NMAP_T1_P2: {
                ...
                {
                    (*(u_int32_t *)(cursor +  0)) = bpf_htonl(0x02040578);
                    (*(u_int32_t *)(cursor +  4)) = bpf_htonl(0x01030306);
                    (*(u_int32_t *)(cursor +  8)) = bpf_htonl(0x0402080a);
                    (*(u_int32_t *)(cursor + 12)) = bpf_htonl(timestampValue);
                    (*(u_int32_t *)(cursor + 16)) = bpf_htonl(0xffffffff);
            ...
            case TCP_NMAP_T1_P3: {
                ...
                {
                    (*(u_int32_t *)(cursor +  0)) = bpf_htonl(0x02040280);
                    (*(u_int32_t *)(cursor +  4)) = bpf_htonl(0x01030306);
            ...
            case TCP_NMAP_T1_P5: {
                ...
                {
                    (*(u_int32_t *)(cursor +  0)) = bpf_htonl(0x02040218);
                    (*(u_int32_t *)(cursor +  4)) = bpf_htonl(0x01030306);
                    (*(u_int32_t *)(cursor +  8)) = bpf_htonl(0x0402080a);
                    (*(u_int32_t *)(cursor + 12)) = bpf_htonl(timestampValue);
                    (*(u_int32_t *)(cursor + 16)) = bpf_htonl(0xffffffff);
            ...
            case TCP_NMAP_T1_P6: {
                ...
                {
                    (*(u_int32_t *)(cursor +  0)) = bpf_htonl(0x02040109);
            ...
            case TCP_NMAP_T4_P1: {
                ...
                // u_int32_t seq = bpf_htonl(bpf_get_prandom_u32());
                // Update TCP packet
