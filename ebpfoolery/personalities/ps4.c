...
// static inline int parse_ipv6(void *data, __u64 nh_off, void *data_end) {
...
int xdp_prog(struct xdp_md *ctx) {
    ...
    // __u32 ip_id_idx = 0;
    // __u32 *ip_id = ip_identification.lookup(&ip_id_idx);
    ...
    // (*ip_id)++;
    __u32 ip_id = bpf_get_prandom_u32();
...
// };
        ...
        __u32 timestampValue = (__u32)(current_time*10);
#ifdef DEBUG
        ...
        switch(nmap_result) {
            case TCP_NMAP_ECN: {
                ...
                */
                ...
                else
                {
                    ...
                    (*(__u32 *)(cursor +  4)) = bpf_htonl(0x01030306);
                    (*(__u32 *)(cursor +  8)) = bpf_htonl(0x04020000);
                }
            ...
            case TCP_NMAP_T1_P2: {
                ...
                {
                    (*(__u32 *)(cursor +  0)) = bpf_htonl(0x02040578);
                    (*(__u32 *)(cursor +  4)) = bpf_htonl(0x01030306);
                    (*(__u32 *)(cursor +  8)) = bpf_htonl(0x0402080a);
                    (*(__u32 *)(cursor + 12)) = bpf_htonl(timestampValue);
                    (*(__u32 *)(cursor + 16)) = bpf_htonl(0xffffffff);
            ...
            case TCP_NMAP_T1_P3: {
                ...
                {
                    (*(__u32 *)(cursor +  0)) = bpf_htonl(0x02040280);
                    (*(__u32 *)(cursor +  4)) = bpf_htonl(0x01030306);
            ...
            case TCP_NMAP_T1_P5: {
                ...
                {
                    (*(__u32 *)(cursor +  0)) = bpf_htonl(0x02040218);
                    (*(__u32 *)(cursor +  4)) = bpf_htonl(0x01030306);
                    (*(__u32 *)(cursor +  8)) = bpf_htonl(0x0402080a);
                    (*(__u32 *)(cursor + 12)) = bpf_htonl(timestampValue);
                    (*(__u32 *)(cursor + 16)) = bpf_htonl(0xffffffff);
            ...
            case TCP_NMAP_T1_P6: {
                ...
                {
                    (*(__u32 *)(cursor +  0)) = bpf_htonl(0x02040109);
            ...
            case TCP_NMAP_T3_P1: {
                ...
                bpf_printk("Sending TCP_NMAP_T3_P1");

                return XDP_TX;
            }
            case TCP_NMAP_T4_P1: {

                // __u32 seq = bpf_htonl(bpf_get_prandom_u32());
                // Update TCP packet
                ...
                bpf_printk("Sending TCP_NMAP_T7_P1");
                return XDP_TX;
            }
            case TCP_NMAP_T5_P1:
            {
            ...
            case TCP_NMAP_T6_P1: {
                ...
                bpf_printk("Sending TCP_NMAP_T6_P1");
                return XDP_TX;
            }
            case TCP_NMAP_T2_P1: {
                return XDP_DROP;
    ...
    else if (ip->protocol == IPPROTO_UDP)
    {
        ...
        ip->tot_len = bpf_htons(bpf_ntohs(ip->tot_len) + new_header_size - udp_data_len);
